...
-- 5. Sistem Audio (Volume dinaikkan jadi 5 agar lebih kencang)
local soundService = game:GetService("SoundService")
local sound = Instance.new("Sound")
sound.SoundId = "rbxassetid://119705891276529"
sound.Volume = 5 -- Diubah dari 1 ke 5 supaya lebih keras!
sound.Parent = soundService

-- 6. Fungsi Tombol Play
playButton.MouseButton1Click:Connect(function()
	if sound.IsPlaying then
		sound:Stop()
	end
	sound:Play()
	print("Audio diputar ulang dengan volume lebih kencang!")
end)
